...
wget -q -O /src/snap/jpy-0.9.0-py38_3.tar.bz2 https://anaconda.org/Terradue/jpy/0.9.0/download/linux-64/jpy-0.9.0-py38_3.tar.bz2
tar xvjf /src/snap/jpy-0.9.0-py38_3.tar.bz2

# # # WORKDIR /work
mkdir -p /root/.snap/snap-python/snappy

mv /src/snap/jpy_wheel/jpy-0.9.0-cp38-cp38-linux_x86_64.whl /root/.snap/snap-python/snappy/
